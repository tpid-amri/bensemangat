...
if ( ! function_exists( 'bensemangat_pagination' ) ) {
	/**
	 ...
	 */
	function bensemangat_pagination( $args = array(), $class = 'pagination' ) {
		...
		$args = wp_parse_args(
			...
			array(
				'mid_size'           => 2,
				'prev_next'          => true,
				'prev_text'          => __( '&laquo;', 'bensemangat' ),
				'next_text'          => __( '&raquo;', 'bensemangat' ),
				'type'               => 'array',
				'current'            => max( 1, get_query_var( 'paged' ) ),
				'screen_reader_text' => __( 'Posts navigation', 'bensemangat' ),
			)
		);
