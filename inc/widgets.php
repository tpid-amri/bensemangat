 ...
 */
add_filter( 'dynamic_sidebar_params', 'bensemangat_widget_classes' );

if ( ! function_exists( 'bensemangat_widget_classes' ) ) {
	 ...
	 * @return array $params
	 */
	function bensemangat_widget_classes( $params ) {
...
} // End of if function_exists( 'bensemangat_widget_classes' ).

add_action( 'widgets_init', 'bensemangat_widgets_init' );

if ( ! function_exists( 'bensemangat_widgets_init' ) ) {
	/**
	 * Initializes themes widgets.
	 */
	function bensemangat_widgets_init() {
		register_sidebar(
			array(
				'name'          => __( 'Right Sidebar', 'bensemangat' ),
				'id'            => 'right-sidebar',
				'description'   => __( 'Right sidebar widget area', 'bensemangat' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Left Sidebar', 'bensemangat' ),
				'id'            => 'left-sidebar',
				'description'   => __( 'Left sidebar widget area', 'bensemangat' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
		...
		register_sidebar(
			array(
				'name'          => __( 'Hero Slider', 'bensemangat' ),
				'id'            => 'hero',
				'description'   => __( 'Hero slider area. Place two or more widgets here and they will slide!', 'bensemangat' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Hero Canvas', 'bensemangat' ),
				'id'            => 'herocanvas',
				'description'   => __( 'Full size canvas hero area for Bootstrap and other custom HTML markup', 'bensemangat' ),
				'before_widget' => '',
				'after_widget'  => '',
				'before_title'  => '',
				'after_title'   => '',
		...
		register_sidebar(
			array(
				'name'          => __( 'Top Full', 'bensemangat' ),
				'id'            => 'statichero',
				'description'   => __( 'Full top widget with dynamic grid', 'bensemangat' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer Full', 'bensemangat' ),
				'id'            => 'footerfull',
				'description'   => __( 'Full sized footer widget with dynamic grid', 'bensemangat' ),
