	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'bensemangat' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'bensemangat' ); ?></th>
			</tr>
		</thead>
		<tbody>
